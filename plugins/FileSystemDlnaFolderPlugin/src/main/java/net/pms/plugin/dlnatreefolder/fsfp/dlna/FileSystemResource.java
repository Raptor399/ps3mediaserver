...
public class FileSystemResource extends VirtualFolder {
	...
	public interface Factory {
		public FileSystemResource create(String name, List<String> folderPaths);
	}
	 ...
	 */
	// FIXME: Plugin needs Guice module!
	@AssistedInject
	public FileSystemResource(PmsCore pmsCore, PmsConfiguration configuration,
			FormatFactory formatFactory, @Assisted String name,
			@Assisted List<String> folderPaths) {
