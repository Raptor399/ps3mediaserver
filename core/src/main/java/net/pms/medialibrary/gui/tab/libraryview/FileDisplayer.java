...
public class FileDisplayer extends JPanel {
	...
	private final FileDisplayTable.Factory fileDisplayTableFactory;
	...
	public interface Factory {
		public FileDisplayer create(FileType fileType);
	}

	@AssistedInject
	public FileDisplayer(FileDisplayTable.Factory fileDisplayTableFactory, @Assisted FileType fileType) {
		super(new GridLayout(1, 1));
		this.fileDisplayTableFactory = fileDisplayTableFactory;
	...
	private void init(){
		...
		tFiles = fileDisplayTableFactory.create(fileType);
