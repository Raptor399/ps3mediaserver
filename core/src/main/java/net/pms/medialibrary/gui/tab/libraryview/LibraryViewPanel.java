...
public class LibraryViewPanel extends JPanel {
	...
	@Inject
	public LibraryViewPanel(FileDisplayer.Factory fileDisplayerFactory){
		super(new GridLayout(1, 1));

		JTabbedPane tp = new JTabbedPane();
		tp.addTab(
				Messages.getString("ML.FileType.VIDEO"),
				new ImageIcon(getClass().getResource("/resources/images/videofolder-16.png")),
				videoFileDisplayer = fileDisplayerFactory.create(FileType.VIDEO));
		tp.addTab(
				Messages.getString("ML.FileType.AUDIO"),
				new ImageIcon(getClass().getResource("/resources/images/audiofolder-16.png")),
				audioFileDisplayer = fileDisplayerFactory.create(FileType.AUDIO));
		tp.addTab(
				Messages.getString("ML.FileType.PICTURES"),
				new ImageIcon(getClass().getResource("/resources/images/picturesfolder-16.png")),
				picturesDisplayer = fileDisplayerFactory.create(FileType.PICTURES));
		tp.addTab(
				Messages.getString("ML.FileType.FILE"),
				new ImageIcon(getClass().getResource("/resources/images/nofilefilter_folder-16.png")),
				fileDisplayer = fileDisplayerFactory.create(FileType.FILE));
