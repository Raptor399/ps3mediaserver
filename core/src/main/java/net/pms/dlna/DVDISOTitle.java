...
public class DVDISOTitle extends DLNAResource {
	...
	public interface Factory {
		public DVDISOTitle create(File f, int title);
	}

	@AssistedInject
	public DVDISOTitle(PmsCore pmsCore, PmsConfiguration configuration,
			ProcessWrapperFactory processWrapperFactory, @Assisted File f, @Assisted int title) {
