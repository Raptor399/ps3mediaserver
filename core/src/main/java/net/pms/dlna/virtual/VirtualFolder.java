...
public class VirtualFolder extends DLNAResource {
	...
	public interface Factory {
		public VirtualFolder create(@Assisted("name") String name, @Assisted("thumbnailIcon") String thumbnailIcon);
	}
	 ...
	 *            the configuration
	 * @param name
	 *            String to be shown in the ContentBrowser service
	 * @param thumbnailIcon
	 *            Represents a thumbnail to be shown. The String represents an
	 *            absolute path. Use null if none is available or desired.
