...
public abstract class VirtualVideoAction extends DLNAResource {
	...
	public interface Factory {
		public VirtualVideoAction create(String name, boolean enabled);
	}
	...
	public VirtualVideoAction(String name, boolean enabled) {
		this(InjectionHelper.getInjector().getInstance(PmsCore.class),
				InjectionHelper.getInjector().getInstance(PmsConfiguration.class), name, enabled);
	}
	...
	public VirtualVideoAction(PmsCore pmsCore, PmsConfiguration configuration,
			@Assisted String name, @Assisted boolean enabled) {
