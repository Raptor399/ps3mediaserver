...
public class RarredEntry extends DLNAResource implements IPushOutput {
	...
	public interface Factory {
		public RarredEntry create(@Assisted("name") String name, File pere,
				@Assisted("fileheadername") String fileheadername, long length);
	}

	/**
	 * Temporary constructor to help with transition to DI.
	 * @deprecated Use {@link #RarredEntry(PmsCore, PmsConfiguration, String, File, String, long)} instead.
	 */
	@Deprecated
