...
public class FFMpegWebVideo extends Player {
	...
	@Inject
	public FFMpegWebVideo(PmsConfiguration configuration, ProcessWrapperFactory processWrapperFactory, PipeProcessFactory pipeProcessFactory) {
	...
	public ProcessWrapper launchTranscode(
		...
		PipeProcess pipe = pipeProcessFactory.create(fifoName);
