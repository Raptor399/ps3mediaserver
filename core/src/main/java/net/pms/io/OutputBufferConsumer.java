...
public class OutputBufferConsumer extends OutputConsumer {
	...
	public interface Factory {
		public OutputBufferConsumer create(InputStream inputStream, OutputParams params);
	}
	...
	@AssistedInject
	public OutputBufferConsumer(
			BufferedOutputFileFactory bufferedOutputFileFactory,
			@Assisted InputStream inputStream, @Assisted OutputParams params) {
		super(inputStream);
