...
public class WindowsNamedPipe extends Thread implements ProcessWrapper {
	...
	public interface Factory {
		public WindowsNamedPipe create(String n, @Assisted("forcereconnect") boolean forcereconnect,
				@Assisted("in") boolean in, OutputParams params);
	}

	@AssistedInject
	public WindowsNamedPipe(PmsCore pmsCore, @Assisted String n,
			@Assisted("forcereconnect") boolean forcereconnect,
			@Assisted("in") boolean in, @Assisted OutputParams params) {
		this.name = "\\\\.\\pipe\\" + n;
		this.in = in;
