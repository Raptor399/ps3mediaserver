...
public class PluginGroupPanel extends JPanel {
	...
	private final PluginDetailDialog.Factory pluginDetailDialogFactory;
	...
	public interface Factory {
		public PluginGroupPanel create(String header, List<PluginBase> plugins);
	}
	 ...
	 */
	@AssistedInject
	public PluginGroupPanel(PluginDetailDialog.Factory pluginDetailDialogFactory,
			@Assisted String header, @Assisted List<PluginBase> plugins) {
		this.pluginDetailDialogFactory = pluginDetailDialogFactory;
		this.header = header;
			...
			for(final PluginBase plugin : plugins) {
				...
				bConfig.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						PluginDetailDialog pdd = pluginDetailDialogFactory.create(plugin);
