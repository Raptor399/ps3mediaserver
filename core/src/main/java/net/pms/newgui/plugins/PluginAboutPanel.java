...
public class PluginAboutPanel extends JPanel {
	...
	private final LinkLabel.Factory linkLabelFactory;
	...
	public interface Factory {
		public PluginAboutPanel create(PluginBase plugin);
	}

	@AssistedInject
	public PluginAboutPanel(LinkLabel.Factory linkLabelFactory, @Assisted PluginBase plugin) {
		this.linkLabelFactory = linkLabelFactory;
		this.plugin = plugin;
	...
	private void build() {
		...
		LinkLabel llWebSite = linkLabelFactory.create(Messages.getString("PluginAboutPanel.1"), websiteUrl);
		...
		LinkLabel llUpdate = linkLabelFactory.create(Messages.getString("PluginAboutPanel.2"), updateUrl);
