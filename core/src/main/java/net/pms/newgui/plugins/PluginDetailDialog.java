...
public class PluginDetailDialog extends JDialog {
	...
	private final PluginAboutPanel.Factory pluginAboutPanelFactory;
	...
	public interface Factory {
		public PluginDetailDialog create(PluginBase plugin);
	}

	@AssistedInject
	public PluginDetailDialog(PluginAboutPanel.Factory pluginAboutPanelFactory,
			@Assisted PluginBase plugin) {
		this.pluginAboutPanelFactory = pluginAboutPanelFactory;
		this.plugin = plugin;		
	...
	private void build() {
		...
		sp.add(pluginAboutPanelFactory.create(plugin));
