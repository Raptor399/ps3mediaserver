/**
 * PMS Note: Avoid changing this file. The contents of this file are a straight
 * forward copy of the MediaInfo library source that can be downloaded from
 * http://mediainfo.sourceforge.net/. Instead, change the {@link MediaInfoWrapper}
 * wrapper class.
 * <p>
 * To obtain the original, download and unpack the source archive. Inside is
 * the file "MediaInfoLib/Source/MediaInfoDLL/MediaInfoDLL.JNA.java".
 */
