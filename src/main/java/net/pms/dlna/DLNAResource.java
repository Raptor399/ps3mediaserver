...
public abstract class DLNAResource extends HTTPResource implements Cloneable, Runnable {
	...
	/**
	 * The DLNA.ORG_PN protocol information string.
	 */
	 ...
	 */
	public abstract DIDLObject getDidlObject(RendererConfiguration renderer, boolean includeChildren);
	...
	/**
	 * Returns the first DLNAResource.
	 *
	 * @return The resource.
	 */
	protected DLNAResource getFirst() {
		return first;
	}

	/**
	 * Sets the first DLNAResource.
	 * 
	 * @param first
	 *            The first resource to set.
	 */
	protected void setFirst(DLNAResource first) {
		this.first = first;
	}

	/**
	 * Sets the DLNA.ORG_PN protocol information string.
	 * 
	 * @deprecated The only reason this method exists is the method
	 * {@link #getDlnaContentFeatures()}, which will be abandoned when the
	 * transition to Cling is complete.
	 * 
	 * @param dlnaspec
	 *            The information string.
	 */
	@Deprecated
	protected void setDlnaSpec(String dlnaspec) {
		this.dlnaspec = dlnaspec;
	}

	/**
	 * Returns the DLNA.ORG_OP string.
	 * 
	 * @deprecated The only reason this method exists is the method
	 * {@link #getDlnaContentFeatures()}, which will be abandoned when the
	 * transition to Cling is complete.
