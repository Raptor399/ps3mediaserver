...
public class CircularByteBuffer {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(CircularByteBuffer.class);
    ...
    protected class CircularByteBufferInputStream extends InputStream {
        ...
        @Override public int available() throws IOException {
            synchronized (CircularByteBuffer.this){
                ...
                LOGGER.warn("Calling available() returns " + (CircularByteBuffer.this.available()));
            ...
            while (true){
                synchronized (CircularByteBuffer.this){
                    ...
                    if (available > 0){
                        ...
                        ensureMark();
                        LOGGER.warn("Calling read() returns " + result);
                        return result;
            ...
            while (true){
                synchronized (CircularByteBuffer.this){
                    ...
                    if (available > 0){
                        ...
                        ensureMark();
                        LOGGER.warn("Calling read(byte[" + cbuf.length + "], " + off + ", " + len + ") returns " + length);
                        return length;
                    } else if (outputStreamClosed){
                        return -1;
                    }
